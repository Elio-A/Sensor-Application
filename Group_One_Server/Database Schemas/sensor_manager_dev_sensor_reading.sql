...
CREATE TABLE `sensor_reading` (
  `sensorReadingID` bigint unsigned NOT NULL AUTO_INCREMENT,
  `serialNumber` varchar(10) NOT NULL,
  `value` double DEFAULT NULL,
  `timestamp` datetime NOT NULL,
  PRIMARY KEY (`sensorReadingID`),
  KEY `serialNumber_idx` (`serialNumber`),
  CONSTRAINT `serialNumber` FOREIGN KEY (`serialNumber`) REFERENCES `sensor` (`serialNumber`)
...
-- Dump completed on 2023-10-19 16:37:52
