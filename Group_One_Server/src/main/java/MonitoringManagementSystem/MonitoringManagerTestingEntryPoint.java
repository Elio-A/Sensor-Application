...
public class MonitoringManagerTestingEntryPoint implements IEntryPoint {
    ...
    private final IFrontEndManagementSystem frontEndManager = new Mock_FrontEndManager();
    ...
    public MonitoringManagerTestingEntryPoint(int maxRetryAttempts) {
